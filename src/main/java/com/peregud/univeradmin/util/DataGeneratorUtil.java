...
public class DataGeneratorUtil {
    ...
    private static final List<String> TASK;
    ...
    public static List<Admin> buildAdmin(int count) {
    ...
    public static List<Course> buildCourse(int count) {
    ...
    public static List<Student> buildStudent(int count) {
    ...
    public static List<StudentResult> buildStudentResult(int count) {
    ...
    public static List<Task> buildTask(int count) {
    ...
    public static List<Teacher> buildTeacher(int count) {
